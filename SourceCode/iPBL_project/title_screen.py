...
if __name__ == "__main__":
    ...
    start_bg.iconbitmap('./iPBL_project/silly.ico')

    # Initialize pygame.mixer for audio
    pygame.mixer.init()

    # Load and play the background music
    background_music = pygame.mixer.Sound("./iPBL_project/alexander-nakarada-silly-intro(chosic.com).mp3")
    background_music.play(loops=-1)  

    # Set background image
    background_image = PhotoImage(file="./iPBL_project/background.png")
